...
namespace Vannatech.CoreAudio.Interfaces {
	...
	public partial interface IAudioChannelConfig {
        ...
        int SetChannelConfig(
            [In][MarshalAs(UnmanagedType.U4)] UInt32 channelConfig, // ETODO: get possible value from ksmedia.h
        ...
        int GetChannelConfig(
            [Out][MarshalAs(UnmanagedType.U4)] out UInt32 channelConfig); // ETODO: get possible value from ksmedia.h
    }
}
