...
namespace Vannatech.CoreAudio.Interfaces {
	...
	public partial interface IAudioClient {
        ...
        int Initialize(
            ...
            [In][MarshalAs(UnmanagedType.SysInt)] IntPtr format, // ETODO: Explore options for WAVEFORMATEX definition here
        ...
        int IsFormatSupported(
            [In][MarshalAs(UnmanagedType.I4)] AUDCLNT_SHAREMODE shareMode,
            [In][MarshalAs(UnmanagedType.SysInt)] IntPtr format, // ETODO: Explore options for WAVEFORMATEX definition here
            [Out, Optional] out IntPtr closestMatch); // ETODO: Sort out WAVEFORMATEX **match (returned)
        ...
        [PreserveSig]
        int GetMixFormat(
            [Out][MarshalAs(UnmanagedType.SysInt)] out IntPtr format); // ETODO: Explore options for WAVEFORMATEX definition here
